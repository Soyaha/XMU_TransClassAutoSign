...
灵感来自 [KrsMt-0113/XMU-Rollcall-bot_qrCode](https://github.com/KrsMt-0113/XMU-Rollcall-Bot)，[fuck_tronclass_sign](https://github.com/wilinz/fuck_tronclass_sign)等项目
...
- **注意**
  ...
  本项目的数字签到采用穷举方式得到签到码，风险较大，有能力可以用fiddler抓包签到接口的响应数据解析签到码
